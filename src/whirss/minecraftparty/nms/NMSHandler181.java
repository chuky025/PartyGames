...
public class NMSHandler181 implements NMSAbstraction {
	...
	public Vector[] getBlockHitbox(org.bukkit.block.Block block) {
		...
		return new Vector[] {
				new Vector(block.getX() + b.getBlock().z(), block.getY() + b.getBlock().B(), block.getZ() + b.getBlock().D()),
				new Vector(block.getX() + b.getBlock().A(), block.getY() + b.getBlock().C(), block.getZ() + b.getBlock().E())
		};
	}
